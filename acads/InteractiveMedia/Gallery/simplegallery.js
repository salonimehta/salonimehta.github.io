...
var simpleGallery_navpanel={
	loadinggif: 'ControlImages/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'50px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ 'ControlImages/left.gif', 'ControlImages/play.gif', 'ControlImages/right.gif', 'ControlImages/pause.gif'], //nav panel images (in that order)
